        ...
        >
            ...
            >
                ...
                <div className={`${styles.flexCenter}  md:flex gap-[33px] hidden`}>
                    ...
                    <Button
                    type="button"
                    className={`rounded-md font-semibold bg-secondary-500 px-8 py-4 hover:bg-primary-500 hover:text-white`}
                    title="Become a Member"
                    onClick={()=> console.log("button clicked")}
                    />
                </div>
                <div className="navbar-links-mobile md:hidden flex gap-[33px]  justify-end items-center z-[100]">
                ...
                </div>
                {
                    ...
                    <div
                    className={`${!toggle ? "hidden" : "flex"}  bg-primary-100 drop-shadow-xl py-[100px]  absolute top-[64px] right-0  my-2 w-full min-h-screen z-100 navbar-links`}
                    >
                    ...
                    <Button
                    type="button"
                    className={`rounded-md font-semibold bg-secondary-500 sm:hidden px-8 py-4 hover:bg-primary-500 hover:text-white`}
                    title="Become a Member"
                    onClick={()=> console.log("button clicked")}
                    />
                    </ul>
